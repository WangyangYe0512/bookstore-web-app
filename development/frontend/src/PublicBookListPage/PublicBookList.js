...
function Bookshelves() {
  ...
  const PUBLIC_BOOKSHELF_URL = 'http://'+window.location.hostname+':3001/api/open/bookshelf'
  const PUBLIC_BOOKSHELF_BOOKLIST_URL = 'http://'+window.location.hostname+':3001/api/open/booklist?booklistId='
