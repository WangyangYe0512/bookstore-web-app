...
function Bookshelves() {
  ...
  const PUBLIC_BOOKSHELF_URL = 'http://3.144.5.98:3000/api/open/bookshelf'
  const PUBLIC_BOOKSHELF_BOOKLIST_URL = 'http://3.144.5.98:3000/api/open/booklist?booklistId='
