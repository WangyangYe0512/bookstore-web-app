...
export default function QuantityEditCart() {
    const GET_BOOKS_URL='http://3.144.5.98:3000/api/cart/';
    const UPDATE_BOOK_URL='http://3.144.5.98:3000/api/cart/update';
    const REMOVE_BOOK_URL='http://3.144.5.98:3000/api/cart/remove';
