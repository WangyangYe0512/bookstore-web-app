...
function Admin(){
    const GET_USER_URL='http://3.144.5.98:3000/api/admin/users';
    const GET_REVIEW_URL='http://3.144.5.98:3000/api/admin/get-reviews';
    const UPDATE_USER_URL='http://3.144.5.98:3000/api/admin/update-user';
    const UPDATE_REVIEW='http://3.144.5.98:3000/api/admin/update-review';
