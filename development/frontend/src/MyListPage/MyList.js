...
function Bookshelves() {
  ...
  const DELETE_BOOKSHELF_URL = '/api/bookshelf/delete?bookshelfId=';
  const CREATE_BOOKSHELF_URL = '/api/bookshelf/create';
  const DELETE_BOOK_FROM_BOOKSHELF_URL = '/api/bookshelf/booklist/delete?booklistId=';
