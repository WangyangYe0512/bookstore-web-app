...
function Bookshelves() {
  ...
  const DELETE_BOOKSHELF_URL = 'http://'+window.location.hostname+':3001/api/bookshelf/delete?bookshelfId=';
  const CREATE_BOOKSHELF_URL = 'http://'+window.location.hostname+':3001/api/bookshelf/create';
  const DELETE_BOOK_FROM_BOOKSHELF_URL = 'http://'+window.location.hostname+':3001/api/bookshelf/booklist/delete?booklistId=';
  const ADD_REVIEW_URL = 'http://'+window.location.hostname+':3001/api/review/add';
